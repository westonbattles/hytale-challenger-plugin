...
public class BossSelectUI extends InteractiveCustomUIPage<BossSelectUI.Data> {
    ...
    private static final int RANDOM_ROLL_SOUND = SoundEvent.getAssetMap().getIndex("RandomRoll");
    ...
    public void handleDataEvent(@Nonnull Ref<EntityStore> ref, @Nonnull Store<EntityStore> store, @Nonnull Data data) {
        ...
        switch (data.clickedButton) {
            case RANDOM_PLAYER_SELECT_BUTTON_ID -> {
                SoundUtil.playSoundEvent2dToPlayer(this.playerRef, RANDOM_ROLL_SOUND, SoundCategory.UI);
